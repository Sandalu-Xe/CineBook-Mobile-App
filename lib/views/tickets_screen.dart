  ...
  Widget build(BuildContext context) {
    ...
    final List<Ticket> tickets = [
      Ticket(
        ...
        cinema: Cinema(id: 'c1', name: 'Liberty Cinema', location: '', distanceKm: 0, latitude: 6.9099, longitude: 79.8510, showtimes: []),
      ...
      Ticket(
        ...
        cinema: Cinema(id: 'c2', name: 'Scope Cinemas', location: '', distanceKm: 0, latitude: 6.9150, longitude: 79.8580, showtimes: []),
